...
const LetterPlaceholder = withTheme()(({ theme, render, active, onDelete, ...props }: IProps) => {
  const child = render();
  return (
    <div className={styles.letterPlaceholder} {...props}>
      ...
      {!!child && (
        <Button style={{ minWidth: 40, marginpadding: '2px 4px', color: theme.palette.error.main }} classes={{ root: styles.deleteButton }} size="small" onClick={onDelete}>
